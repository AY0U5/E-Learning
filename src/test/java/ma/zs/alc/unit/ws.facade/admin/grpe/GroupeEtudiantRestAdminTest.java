...
import ma.zs.alc.ws.facade.admin.grpe.GroupeEtudiantRestAdmin;
...
public class GroupeEtudiantRestAdminTest {

    private MockMvc mockMvc;

    @Mock
    private GroupeEtudiantAdminServiceImpl service;
    @Mock
    private GroupeEtudiantConverter converter;

    @InjectMocks
    private GroupeEtudiantRestAdmin controller;
